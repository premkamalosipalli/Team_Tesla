...
public class PaymentServices {
	...
	private Payer getPayerInformation(RegistrationEntity registrationEntity) {
		...
		payerInfo.setFirstName(registrationEntity.getFirstName()).setLastName(registrationEntity.getLastName())
	...
	private List<Transaction> getTransactionInformation(OrderDetail orderDetail) {
		...
		// ### Items
		Item item = new Item();
		item.setName(orderDetail.getProductName()).setQuantity("1").setCurrency("USD")
				.setPrice(orderDetail.getSubtotal()).setTax(orderDetail.getTax());
