...
@media only screen and (max-width: 620px) {
	...
	table.body p, table.body ul, table.body ol, table.body td, table.body span,
		table.body a {
								...
								<table role="presentation" border="0" cellpadding="0"
									...
									<tr>
										<td>
											...
											<p>
												Thank you for your purchase. A confiramtion email has been
												send to
												<%=request.getParameter("emailId") %>We look forward to
												seeing you at the theatre. Your tickets have been saved to
												your account. At the theatre, proceed directly to the ticket
												podium and scan this barcode to use your contactless
												tickets.
											</p>
											<table role="presentation" border="0" cellpadding="0"
											...
											<p>At the theatre podium, show your barcode to pick up
												your tickets.</p>
